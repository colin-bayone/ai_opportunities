...
**Engagement:** Walmart - Supply Chain and Store Health Monitoring
...
Example: `01_context_people_2026-03-30.md` means this is from document set 01 (pre-engagement context build), covers people, and the source material is from March 30, 2026.
...
**Source:** /walmart/supply_chain_store_health_monitoring/source/<filename>
...
Between numbered document sets, a **bridge document** captures what changed (e.g., `01-02_changes_2026-03-30.md`). These are written after both sets exist and describe:
...
2. **Living org chart** (`/walmart/supply_chain_store_health_monitoring/org_chart.md`): Always reflects the most current and complete understanding of all people across all events. This file IS updated over time. It is the one exception to append-only, because its purpose is to be a current-state reference.
