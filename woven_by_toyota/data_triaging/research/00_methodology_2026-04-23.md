...
**Engagement:** Woven by Toyota - Data Triaging for Autonomous Vehicle Telemetry
...
Example: `01_meeting_people_2026-04-13.md` means this is from document set 01 (the April 13 internal sync), covers the people on the call, and the source material is from April 13, 2026.
...
**Source:** /woven_by_toyota/data_triaging/source/<path_to_file>
...
Between numbered document sets, a **bridge document** captures what changed (e.g., `01-02_changes_2026-04-20.md`). These are written after both sets exist and describe:
...
2. **Living org chart** (`/woven_by_toyota/data_triaging/org_chart.md`): Always reflects the most current and complete understanding of all people across all events. This file IS updated over time. It is the one exception to append-only, because its purpose is to be a current-state reference.
