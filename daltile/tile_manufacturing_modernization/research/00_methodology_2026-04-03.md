...
**Engagement:** DalTile - Tile Manufacturing Modernization
...
Example: `01_meeting_people_2026-04-03.md` means this is from document set 01 (the discovery meeting), covers people, and the source material is from April 3, 2026.
...
**Source:** /daltile/tile_manufacturing_modernization/source/<filename>
...
- **Summary file** (always last): Short, high-level overview referencing all files in the set.

### Bridge Documents

Between numbered document sets, a **bridge document** captures what changed (e.g., `01-02_changes_2026-04-03.md`). These are written after both sets exist and describe:
...
2. **Living org chart** (`/daltile/tile_manufacturing_modernization/org_chart.md`): Always reflects the most current and complete understanding of all people across all events. This file IS updated over time. It is the one exception to append-only, because its purpose is to be a current-state reference.
