...
> **FROZEN SNAPSHOT — NOT AUTHORITATIVE.**
> This file is a point-in-time copy from 2026-03-20 that was carried along when the Lam Research engagement was copied into this directory as the Singularity skill's worked example. It is preserved here to keep the worked example self-consistent, not as a source of current skill guidance.
>
> For the authoritative and current skill notes, see:
> - Latest consolidated feedback: `claude/singularity_feedback/` (most recent `YYYY-MM-DD_round_NN/` folder)
> - Latest skill-authoritative reference: the most recent `skill_notes.md` in the actual Lam engagement planning folder, or whatever has been promoted into `.claude/skills/singularity/references/`.
>
> Do not rely on this file for current rules, patterns, or corrections. Many failure patterns and rules were added after this snapshot.
