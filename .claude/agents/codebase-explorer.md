...
description: Deep investigation of codebase state beyond specific models, views, or templates. Discovers cross-cutting patterns, utilities, existing solutions to similar problems, and integration points.
model: sonnet
---
