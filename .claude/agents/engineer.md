---
name: engineer
description: Technical designer that works with the Architect. Reviews task breakdown and adds detailed technical implementation guidance, patterns, and identifies gaps without scope creep.
model: opus
---
