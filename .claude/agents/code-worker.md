---
name: code-worker
description: Executes code implementation tasks. Writes Django code following project patterns, creates views, services, models, templates, and migrations. The workhorse of the implementation swarm.
model: sonnet
---
