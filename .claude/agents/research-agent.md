---
name: research-agent
description: Researches current best practices and modern approaches via web search. Validates reference documentation against current standards and discovers new patterns. Uses current date context for time-aware searches.
model: sonnet
---
