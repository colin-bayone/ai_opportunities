---
name: view-explorer
description: Deep analysis of Django views, services, and URL routing. Documents existing patterns, authentication requirements, and service layer architecture to inform implementation.
model: sonnet
---
