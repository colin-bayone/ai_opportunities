...
Example: `01_meeting_technical_landscape_2026-02-09.md` means this is from document set 01 (the initial meeting), covers the technical landscape, and the source material is from February 9, 2026.
...
**Source:** /cisco/epnm_ems/source/<filename>
...
Between numbered document sets, a **bridge document** captures what changed (e.g., `01-02_changes_2026-02-20.md`). These are written after both sets exist and describe:
...
2. **Living org chart** (`/cisco/epnm_ems/org_chart.md`): Always reflects the most current and complete understanding of all people across all events. This file IS updated over time. It is the one exception to append-only, because its purpose is to be a current-state reference.
