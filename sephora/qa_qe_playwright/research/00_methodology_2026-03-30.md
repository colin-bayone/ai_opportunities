...
**Engagement:** Sephora - QA/QE Automation with Playwright and Generative AI
...
**Source:** /sephora/qa_qe_playwright/source/<filename>
...
2. **Living org chart** (`/sephora/qa_qe_playwright/org_chart.md`): Always reflects the most current and complete understanding of all people across all events. This file IS updated over time. It is the one exception to append-only, because its purpose is to be a current-state reference.
